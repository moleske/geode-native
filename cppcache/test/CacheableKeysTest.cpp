...
TEST(CacheableKeysTest, int8TDifferentHashCodes) {
...
TEST(CacheableKeysTest, int16TDifferentHashCodes) {
  EXPECT_NE(hashcode(static_cast<int8_t>(37)),
            hashcode(static_cast<int8_t>(42)))
      << "Two different int16_t values have different hashcodes";
}

TEST(CacheableKeysTest, int32TDifferentHashCodes) {
  EXPECT_NE(hashcode(static_cast<int8_t>(37)),
            hashcode(static_cast<int8_t>(42)))
      << "Two different int32_t values have different hashcodes";
}

TEST(CacheableKeysTest, int64TDifferentHashCodes) {
  EXPECT_NE(hashcode(static_cast<int8_t>(37)),
            hashcode(static_cast<int8_t>(42)))
