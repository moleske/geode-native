...
TEST(utilChronoDurationTest, ceil) {
...
TEST(utilChronoDurationTest, toString) {
...
TEST(utilChronoDurationTest, fromString) {
...
TEST(utilChronoDurationTest, fromStringWithCeil) {
...
TEST(utilChronoDurationTest, fromStringException) {
  ASSERT_THROW(from_string("42"), std::invalid_argument);
}

TEST(utilChronoDurationTest, assertBounds) {
