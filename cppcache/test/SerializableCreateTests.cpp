...
TEST(SerializableCreateTests, forArrayOfChar16T) {
...
TEST(SerializableCreateTests, forArrayOfChar32T) {
  const auto serializable = Serializable::create(U"test");
  ASSERT_TRUE(nullptr != serializable);
  auto&& cacheableString =
      std::dynamic_pointer_cast<CacheableString>(serializable);
...
TEST(SerializableCreateTests, forArrayOfWcharT) {
...
TEST(SerializableCreateTests, forInt8T) {
...
TEST(SerializableCreateTests, forInt16T) {
...
TEST(SerializableCreateTests, forInt32T) {
...
TEST(SerializableCreateTests, forInt64T) {
...
TEST(SerializableCreateTests, forChar16T) {
