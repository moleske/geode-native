...
TEST(CacheableKeyCreateTests, forArrayOfChar16T) {
...
TEST(CacheableKeyCreateTests, forArrayOfChar32T) {
  const auto cacheableKey = CacheableKey::create(U"test");
  ASSERT_TRUE(nullptr != cacheableKey);
  auto&& cacheableString =
      std::dynamic_pointer_cast<CacheableString>(cacheableKey);
...
TEST(CacheableKeyCreateTests, forArrayOfWcharT) {
...
TEST(CacheableKeyCreateTests, forInt8T) {
...
TEST(CacheableKeyCreateTests, forInt16T) {
...
TEST(CacheableKeyCreateTests, forInt32T) {
...
TEST(CacheableKeyCreateTests, forInt64T) {
...
TEST(CacheableKeyCreateTests, forChar16T) {
